...
def chinese_cut(in_file, out_file):
    """中文分词处理"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--src_lang", default="zh", type=str, help="source language")
    ...
    for mode in ["train", "val", "test"]:
        ...
        if args.src_lang == "zh":
            chinese_cut(
                local_data_path / f"{mode}.{args.src_lang}",
        ...
        # 目标语言处理（英文）
        moses_cut(
            local_data_path / f"{mode}.{args.trg_lang}",
